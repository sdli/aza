...
function LockRequest(url, options, lockOptions) {
    var reqData = JSON.stringify({ url: url, options: options });
...
function AutoUnlock(url, options, lockOptions) {
    if (typeof lockOptions === "undefined" || typeof lockOptions.open === "undefined" || lockOptions.open) {
        setTimeout(function () {
            UNLOCK(url, options);
        }, lockOptions && typeof lockOptions.timeout !== "undefined" ? lockOptions.timeout : 15000);
    }
}
...
exports.default = function (store, lockOptions) {
